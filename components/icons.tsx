...
export const GripVerticalIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75h6m-6-3h6m-6-3h6M9 12.75h6m-6 3h6m-6 3h6" />
    </svg>
);
...
export const TrophyIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9a9.75 9.75 0 0 1-4.874-1.956.5.5 0 0 1 .18-1.028A13.441 13.441 0 0 0 12 15c4.39 0 8.23-2.03 10.194-5.234a.5.5 0 0 1 .18 1.028A9.75 9.75 0 0 1 16.5 18.75Zm0 0V21m-9-2.25V21M12 15V3.75m0 0L8.25 7.5M12 3.75 15.75 7.5" />
    </svg>
);
